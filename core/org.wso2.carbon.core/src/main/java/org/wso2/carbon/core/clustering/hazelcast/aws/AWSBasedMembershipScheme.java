...
public class AWSBasedMembershipScheme implements HazelcastMembershipScheme {
    ...
    private static final String SECURE_VAULT_ACCESS_KEY = "Axis2.clustering.aws.accessKey";
    private static final String SECURE_VAULT_SECRET_KEY = "Axis2.clustering.aws.secretKey";
